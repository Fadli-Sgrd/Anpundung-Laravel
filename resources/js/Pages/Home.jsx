        ...
        <>
            ...
            <div className="w-screen ml-[calc(50%-50vw)] -mt-28 relative overflow-hidden mb-16">
                <div className="relative w-full h-screen overflow-hidden">
                    <div
                        className={`absolute inset-0 bg-fixed bg-center bg-cover z-0 transition-transform duration-[3000ms] ease-out transform ${
                            loaded ? "scale-100" : "scale-110"
                        }`}
                        style={{
                            backgroundImage:
                                "url('https://images.unsplash.com/photo-1611638281871-1063d3e76e1f?q=80&w=1433&auto=format&fit=crop')",
                        }}
                    ></div>
                    ...
                    <div className="relative z-20 h-full flex flex-col items-center justify-center text-center px-4 pt-20">
                        <div
                            className={`transition-all duration-1000 ease-out transform translate-y-10 opacity-0 ${
                        ...
                        <h1
                            className={`text-5xl md:text-8xl font-extrabold text-white mb-6 leading-tight drop-shadow-2xl transition-all duration-1000 delay-300 ease-out transform translate-y-10 opacity-0 ${
                                loaded ? "!translate-y-0 !opacity-100" : ""
                            }`}
                        >
                            Bandung <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-blue-300 to-blue-200">
                                Bebas Pungli
                            </span>
                        </h1>

                        <p
                            className={`text-lg md:text-2xl text-slate-200 mb-12 max-w-2xl mx-auto font-light leading-relaxed drop-shadow-md transition-all duration-1000 delay-500 ease-out transform translate-y-10 opacity-0 ${
                                loaded ? "!translate-y-0 !opacity-100" : ""
                            }`}
                        >
                            Bersama ANPUNDUNG, wujudkan layanan publik yang
                            bersih, transparan, dan bermartabat.
                        </p>

                        <div
                            className={`flex flex-col sm:flex-row items-center gap-5 transition-all duration-1000 delay-700 ease-out transform translate-y-10 opacity-0 ${
                                loaded ? "!translate-y-0 !opacity-100" : ""
                            }`}
                        >
                            {auth.user ? (
                                ...
                                >
                                    <i className="bx bxs-megaphone text-xl"></i>{" "}
                                    Laporkan Sekarang
                                </button>
                            ) : (
                                <a
            ...
            <section
                id="tentang"
                className="max-w-7xl mx-auto px-4 mb-32 pt-24"
            >
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    <div className="lg:w-1/2 reveal-on-scroll">
                        ...
                        <p className="text-lg text-slate-600 mb-8 leading-relaxed text-justify">
                            Anpundung hadir untuk menjembatani warga Bandung
                            dengan pengelola lingkungan dalam memberantas
                            praktik pungutan liar. Sistem ini dirancang untuk
                            memberikan rasa aman bagi pelapor dan memastikan
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16 reveal-on-scroll">
                        <h2 className="text-3xl md:text-5xl font-extrabold text-slate-900 mb-4">
                            Lapor Pungli Semudah 1-2-3
                        </h2>
                        <p className="text-slate-500 text-lg">
                            Jangan takut melapor. Sistem kami melindungi privasi
                            Anda.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="reveal-on-scroll bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-xl transition group relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-slate-500 leading-relaxed">
                                    Isi formulir kejadian dengan lengkap.
                                    Lampirkan foto atau video sebagai bukti
                                    pendukung yang kuat.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="reveal-on-scroll delay-100 bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-xl transition group relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-slate-500 leading-relaxed">
                                    Admin kami akan memvalidasi laporan Anda.
                                    Anda dapat memantau statusnya pada riwayat
                                    laporan Anda secara realtime.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="reveal-on-scroll delay-200 bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-xl transition group relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-slate-500 leading-relaxed">
                                    Laporan valid akan ditindaklanjuti oleh
                                    pihak berwenang. Lingkungan kembali aman dan
                                    nyaman.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="relative z-10 max-w-4xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-6">
                            {auth.user ? (
                                ...
                                >
                                    <i className="bx bx-plus-circle"></i> Buat
                                    Laporan
                                </button>
                            ) : (
                                <a
                                ...
                                >
                                    <i className="bx bx-user-plus"></i> Daftar
                                    Akun
                                </a>
                            )}
                        </div>
