    ...
    <div class="max-w-6xl mx-auto px-4">
        ...
        <div class="grid md:grid-cols-3 gap-8 items-start">
            ...
            <div class="md:col-span-1 space-y-6">
                <div class="bg-gradient-to-br from-blue-600 to-slate-900 rounded-[2rem] p-8 text-white relative overflow-hidden shadow-xl shadow-blue-200">
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="space-y-6">
                            <div class="flex items-start gap-4">
                                <div class="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center shrink-0 backdrop-blur-sm">
                ...
                <div class="bg-blue-50 rounded-2xl p-6 border border-blue-100">
                    ...
                    <p class="text-xs text-blue-600/80 leading-relaxed">
                        Untuk pelaporan pungli yang mendesak, disarankan menggunakan menu <a href="/laporan/create" class="font-bold underline hover:text-blue-800">Buat Laporan</a> agar langsung masuk ke sistem prioritas kami.
                    </p>
                </div>
            </div>
                    ...
                    <form method="POST" action="/kontak" class="space-y-5">
                        ...
                        <div class="grid md:grid-cols-2 gap-5">
                            <div>
                                ...
                                @error('nama') <div class="text-red-500 text-xs mt-1 font-medium">{{ $message }}</div> @enderror
                            </div>
                            ...
                            <div>
                                ...
                                @error('email') <div class="text-red-500 text-xs mt-1 font-medium">{{ $message }}</div> @enderror
                            </div>
                        </div>

                        <div>
                            <label for="subject" class="block text-sm font-bold text-slate-700 mb-2">Subjek Pesan</label>
                            <input type="text" id="subject" name="subject" value="{{ old('subject') }}" required 
                                class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition text-sm text-slate-700 placeholder-slate-400 font-medium"
                                placeholder="Contoh: Kendala Login / Saran Fitur">
                            @error('subject') <div class="text-red-500 text-xs mt-1 font-medium">{{ $message }}</div> @enderror
                        </div>
                        ...
                        <div>
                            ...
                            @error('message') <div class="text-red-500 text-xs mt-1 font-medium">{{ $message }}</div> @enderror
                        </div>
